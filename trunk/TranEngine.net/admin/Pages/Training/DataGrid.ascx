<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DataGrid.ascx.cs" Inherits="admin_Pages_Training_DataGrid" %>
    ...
    <asp:GridView ID="gridComments" BorderColor="#F8F8F8" BorderStyle="Solid" BorderWidth="1px"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="20">
                <ItemTemplate>
                    <asp:CheckBox ID="chkSelect" runat="server" ToolTip='<%#HasNoChildrenAndApped((Guid)DataBinder.Eval(Container.DataItem, "Id"))?"未发布":""%>' />
                </ItemTemplate>
            ...
            <asp:TemplateField HeaderText="教师" HeaderStyle-HorizontalAlign="Left">
                <ItemTemplate>
                    <asp:Literal ID="ltTeacher" Text='<%#DataBinder.Eval(Container.DataItem, "Teacher") + "" %>'
                        runat="server" />
                </ItemTemplate>
                <HeaderStyle HorizontalAlign="Left" Width="80px"></HeaderStyle>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="培训天数" HeaderStyle-HorizontalAlign="Left">
                <ItemTemplate>
                    <asp:Literal ID="ltDays" Text='<%#DataBinder.Eval(Container.DataItem, "Days") + "天" %>'
                        runat="server" />
                </ItemTemplate>
                <HeaderStyle HorizontalAlign="Left" Width="80px"></HeaderStyle>
            </asp:TemplateField>
...
<div style="text-align: center; padding-top: 10px">
    ...
    <asp:Button ID="btnDelete" runat="server" Text="<%$ Resources:labels, delete %>"
        ...
        <asp:Button ID="btnSetGold" runat="server" Text="精品课程设置" onclick="btnSetGold_Click"
         />
</div>
