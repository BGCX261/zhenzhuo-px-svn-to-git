<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DataGrid.ascx.cs" Inherits="admin_Pages_Excellent_DataGrid" %>
...
<div style="border: 1px solid #f3f3f3;">
    <asp:GridView ID="gridComments" BorderColor="#F8F8F8" BorderStyle="Solid" BorderWidth="1px"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="标题" HeaderStyle-HorizontalAlign="Left">
                <ItemTemplate>
                    <asp:LinkButton ID="lnk" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "Title").ToString()%>'
                        OnClientClick='<%#GetEditHtml(DataBinder.Eval(Container.DataItem, "Id").ToString(),"Editor.aspx",1000, 460)%>' />
                </ItemTemplate>
            ...
            <asp:TemplateField HeaderText="培训地点" HeaderStyle-HorizontalAlign="Left">
                <ItemTemplate>
                    <asp:Literal ID="ltDays" Text='<%#DataBinder.Eval(Container.DataItem, "CityTown")  %>'
                        runat="server" />
                </ItemTemplate>
                <HeaderStyle HorizontalAlign="Left" Width="80px"></HeaderStyle>
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="编辑" HeaderStyle-HorizontalAlign="Left">
                <ItemTemplate>
                    ...
                    Visible='<%#HasNoChildrenAndApped((Guid)DataBinder.Eval(Container.DataItem, "Id"))%>'
                        OnClientClick='<%#GetEditHtml(DataBinder.Eval(Container.DataItem, "Id").ToString(),"Editor.aspx",600, 460)%>' />
                </ItemTemplate>
