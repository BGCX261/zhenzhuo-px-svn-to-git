...
public partial class admin_Pages_Training_Menu : System.Web.UI.UserControl
{
    ...
    protected void BuildMenuList()
    {
        ...
        {
            hdr.InnerHtml = string.Format("{0}: {1}", "培训现场管理", labels.inbox);
        }
        ...
        if (this.Page.User.IsInRole("administrators"))
        {
            ...
            {
                hdr.InnerHtml = string.Format("{0}: {1}", "培训现场管理", labels.approved);
            }
