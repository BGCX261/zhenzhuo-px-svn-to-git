...
public partial class admin_Pages_Curricula_Menu : System.Web.UI.UserControl
{
    ...
    protected void BuildMenuList()
    {
        ...
        {
            hdr.InnerHtml = string.Format("{0}: {1}", "公开课管理", labels.inbox);
        }
        ...
        if (this.Page.User.IsInRole("administrators"))
        {
            ...
            {
                hdr.InnerHtml = string.Format("{0}: {1}", "公开课管理", labels.approved);
            }
