<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Menu.ascx.cs" Inherits="admin_Pages_Curricula_Menu" %>
<table width="100%" 
    style="border:none; padding: 0; margin: 0; margin-bottom: 10px;" border="0">
    <tr　>
        <td height="30" >
