...
<asp:Content ID="Content1" ContentPlaceHolderID="cphAdmin" runat="Server">
    ...
    <div class="settings">
        ...
        <div style="margin-bottom:3px">
        <label for="<%=cbUseTrainNameInPageTitles.ClientID %>"><%=Resources.labels.useTrainNameInPageTitles%></label>
        <asp:CheckBox runat="server" ID="cbUseTrainNameInPageTitles" /><%=Resources.labels.useTrainNameInPageTitlesDescription%>
        </div>
        <div style="margin-bottom:3px">
    ...
    <div class="settings">
        ...
        <div style="margin-bottom:3px">
        <label for="<%=txtTrainChannelBLink.ClientID %>"><%=Resources.labels.endorsment %></label>
        <asp:TextBox runat="server" ID="txtTrainChannelBLink" MaxLength="255" Width="300" />
        </div>
        <div style="margin-bottom:3px">
