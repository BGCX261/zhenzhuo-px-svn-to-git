<%@ Control Language="C#" AutoEventWireup="true" CodeFile="GridOrgansList.ascx.cs" Inherits="User_controls_Teacher_GridOrgansList" %>
        ...
        <ItemTemplate>
            <table border="0" cellpadding="0" cellspacing="0" width="100%" 
                ...
                <td style="text-align:left;width:90px">
                    <a id="a1" runat="server" href="Javascript:void(0)" title='<%#DataBinder.Eval(Container.DataItem, "company").ToString()%>'>
                ...
                <div style ="border: 1px solid #DDDDDD; height:80px;">
                    <div style='float:left ;width:75%' ><strong>机构名称:<a id="aPages" runat="server" href="Javascript:void(0)" title='<%#DataBinder.Eval(Container.DataItem, "company").ToString()%>'><%#StripString(DataBinder.Eval(Container.DataItem, "company").ToString(), 24, false)%></a></strong></div>
                    <div style='float:left;margin: 0  0  0 20px;'><strong>所在城市:</strong><asp:Label ID="ltAddress" runat="server"></asp:Label></div>
                    <div style="clear:both">
                    </div>
                    <div><strong>机构简介:</strong><asp:Label ID="ltDes" runat="server"></asp:Label></div>
                </div>
