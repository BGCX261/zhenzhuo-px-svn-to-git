...
<%@ Import Namespace="TrainEngine.Core.Web.Controls" %>
<%@ Import Namespace="TrainEngine.Core.Web" %>
...
<script RunAt="server">
  ...
  /// <param name="e"></param>
    void Application_Error(object sender, EventArgs e)
    {
        ...
        if (TrainSettings.Instance.EnableErrorLogging)
    ...
    ///   {
    ///     //Hook up to the TrainEngine.NET events.
    ///   }
    /// }
    /// </code>
    /// </example>
    ...
    void Application_PreRequestHandlerExecute(object sender, EventArgs e)
    {
        ...
        {
            if (!TrainSettings.Instance.Culture.Equals("Auto"))
            {
