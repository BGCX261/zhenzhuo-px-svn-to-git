<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Rzcp.aspx.cs" Inherits="Rzcp" %>
...
<div id="DivLeftMiddle">
  <div class="Div_Content" style="padding-top:5px;">
  	<uc1:GridRzList id="DGridOrgansList" RzType="产品认证" runat="server"></uc1:GridRzList>
  </div>
</div>
...
<div id="DivRight">
    ...
    <div class="list" >
      <uc6:GridRzsf id="GridRzList1" RzType="产品认证收费" pType="认证收费" runat="server"></uc6:GridRzsf>
      </div>
  </div>
