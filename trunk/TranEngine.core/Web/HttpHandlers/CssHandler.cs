...
namespace TrainEngine.Core.Web.HttpHandlers
{
	...
	public class CssHandler : IHttpHandler
	{
		...
		public void ProcessRequest(HttpContext context)
		{
			...
			{
				string fileName = context.Request.QueryString["name"].Replace(TrainSettings.Instance.Version(), string.Empty) ;
				...
				if (!string.IsNullOrEmpty(css))
				{
					...
					if (TrainSettings.Instance.EnableHttpCompression)
					 TrainEngine.Core.Web.HttpModules.CompressionModule.CompressResponse(context);
