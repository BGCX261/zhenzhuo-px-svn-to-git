  ...
  public class OpenSearchHandler : IHttpHandler
  {
    ...
    public void ProcessRequest(HttpContext context)
    {
      ...
      using (XmlWriter writer = XmlWriter.Create(context.Response.OutputStream, settings))
      {
        ...
        writer.WriteElementString("ShortName", TrainSettings.Instance.Name);
        writer.WriteElementString("Description", TrainSettings.Instance.Description);
      ...
      TrainSettings.Changed += delegate { context.Response.Cache.SetExpires(DateTime.Now.AddDays(30)); };
    }
