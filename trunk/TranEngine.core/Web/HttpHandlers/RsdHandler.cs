  ...
  public class RsdHandler : IHttpHandler
  {
    ...
    {      
      ...
      using (XmlTextWriter rsd = new XmlTextWriter(context.Response.OutputStream, Encoding.UTF8))
      {
        ...
        rsd.WriteElementString("engineName", "TrainEngine.NET " + TrainSettings.Instance.Version());
        ...
        rsd.WriteAttributeString("preferred", "true");
				string prefix = TrainSettings.Instance.RequireSSLMetaWeblogAPI ? "https://" : "http://";
        ...
        // TrainML
        rsd.WriteStartElement("api");
        rsd.WriteAttributeString("name", "TrainML");
        rsd.WriteAttributeString("preferred", "false");
        rsd.WriteAttributeString("apiLink", Utils.AbsoluteWebRoot + "api/TrainImporter.asmx");
        rsd.WriteAttributeString("blogID", Utils.AbsoluteWebRoot.ToString());
        rsd.WriteEndElement();
