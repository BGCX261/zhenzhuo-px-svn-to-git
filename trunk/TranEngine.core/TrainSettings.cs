...
namespace TrainEngine.Core
{
	...
	public class TrainSettings
	{
		...
		private static TrainSettings TrainSettingsSingleton;
		...
		//	CONSTRUCTORS
		//============================================================
		#region TrainSettings()
		/// <summary>
		/// Initializes a new instance of the <see cref="TrainSettings"/> class.
		/// </summary>
		private TrainSettings()
		{
			//------------------------------------------------------------
		...
		#region Instance
		/// <summary>
		/// Gets the singleton instance of the <see cref="TrainSettings"/> class.
		/// </summary>
		/// <value>A singleton instance of the <see cref="TrainSettings"/> class.</value>
		/// <remarks></remarks>
		public static TrainSettings Instance
		{
			get
			{
				if (TrainSettingsSingleton == null)
				{
					TrainSettingsSingleton = new TrainSettings();
				}
				return TrainSettingsSingleton;
			}
		}
		#endregion
		...
		{
			get { return ConfigurationManager.AppSettings["TrainEngine.FileExtension"] ?? ".aspx"; }
		}
		#endregion
		...
		{
			get { return ConfigurationManager.AppSettings["TrainEngine.AdminRole"] ?? "administrators"; }
		}
		#endregion
		...
		/// <seealso cref="TrainEngine.Core.SyndicationFormat"/>
		...
		#region UseTrainNameInPageTitles
		/// <summary>
		/// Gets or sets a value indicating if whitespace in stylesheets should be removed
		/// </summary>
		/// <value><b>true</b> if whitespace is removed, otherwise returns <b>false</b>.</value>
		public bool UseTrainNameInPageTitles { get; set; }
		#endregion
		...
		public int TrainrollMaxLength { get; set; }
		#endregion

		#region TrainrollUpdateMinutes
		/// <summary>
		...
		public int TrainrollUpdateMinutes { get; set; }
		#endregion

		#region TrainrollVisiblePosts
		/// <summary>
		...
		public int TrainrollVisiblePosts { get; set; }
		#endregion
		...
		#region Load()
		/// <summary>
		/// Initializes the singleton instance of the <see cref="TrainSettings"/> class.
		/// </summary>
		private void Load()
		{
			...
			//------------------------------------------------------------
			System.Collections.Specialized.StringDictionary dic = Providers.TrainService.LoadSettings();
			...
			StorageLocation = Providers.TrainService.GetStorageLocation();
		}
		#endregion
		...
		/// <summary>
		/// Returns the TrainEngine.NET version information.
		/// </summary>
		/// <value>The TrainEngine.NET major, minor, revision, and build numbers.</value>
		/// <remarks>The current version is determined by extracting the build version of the TrainEngine.Core assembly.</remarks>
